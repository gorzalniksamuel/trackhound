...
export class ReportGenerator {
  ...
  generateMarkdown(): string {
    ...
    // Footer
    lines.push("---");
    lines.push(`*Generated by Trackhound v0.1.0*\n`);
...
<head>
  ...
  <title>Trackhound Report - ${this.manifest.run.id}</title>
  <style>
...
<body>
  <div class="container">
    ...
    <div class="footer">
      Generated by Trackhound v0.1.0
    </div>
  </div>
</body>
</html>
`;
  ...
  private getRunDir(): string {
    return path.join(process.cwd(), ".trackhound", "runs", this.manifest.run.id);
  }
}
